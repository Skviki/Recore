...
public class AboutGui
{
    ...
    public static void Start()
    {
        ...
        var bottomPanel = new Box(Orientation.Horizontal, 0);
        var version = new Label($"Version : {Logic.version}");
        var updateBtn = new Button("Check for Updates");
        ...
        content.PackStart(bottomPanel,false,true,5);
        bottomPanel.PackStart(version,true,true,5);
        bottomPanel.PackStart(updateBtn,false,true,0);
        header.Xalign = 0;
        authors.Xalign = 0;
        usingText.Xalign = 0;
        about.Xalign = 0;
